...
export const App = () => {
  return (
    <div className="main-container">
      <section className="user_secion">
        <GetUserElem user={user} />
      </section>
      <section className="statistics_secion">
        <Statistics title="Upload stats" stats={label} />
      </section>
      <section className="friend_secion">
